...
url = "https://stats.nba.com/stats/scoreboard/?GameDate=01/11/2019&LeagueID=00&DayOffset=0"  # what does this look like?
headers = {
...
def summary_clutch(player, season):
    """
    Returns some summary clutchtime stats.
    Clutchtime defined as last five mins of a game, +/- 5 points
    """
...
def create_shot_chart(player, season, last_n=0, summary_stats=True,
    ...
    Params:
    player - Player name. Needs to be spelled correctly (.lower()??)
    season - Needs to be "20xx-xx" format
    last_n - last n games. If 0 takes whole season
    """
